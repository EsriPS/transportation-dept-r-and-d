...
> {
  ...
  onAcceptRelocateEventUrlValue = (event) => {
    console.log("onAcceptRelocateEventUrlValue called: " + event)
    this.props.onSettingChange({
      id: this.props.id,
          ...
          <SettingRow>
            ...
            <div style={{display: 'flex',flexDirection: 'column'}}>
              ...
              <TextInput
                  ...
                  // placeholder="https://..."
                  defaultValue={this.props.config.relocateEventUrl}
                  onAcceptValue={this.onAcceptRelocateEventUrlValue}></TextInput>
            </div>
