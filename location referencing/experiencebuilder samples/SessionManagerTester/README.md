Simple test harness used to assess users sign in status, available/related props and their availability. Also example APP_CONFIG_PROCESSOR extension point implementation.
